...
export const en: Content = {
  ...
  howSection: {
    ...
    items: [
      ...
      },
      {
        ...
        list: ["Build the community's trust and commitment", 'Get instant feedback and start conversations'],
      },
    ],
  },
  counters: [
  ...
  customersPage: {
    ...
    items: [
      {
        title: 'Saue',
        description: 'Municipality of Saue',
        image: '/images/customers/saue.jpg',
        href: 'https://sauevald.ee/',
      },
      {
        title: 'Boden',
        description: 'Municipality of Boden',
