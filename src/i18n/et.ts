...
export const et: Content = {
  ...
  blogSection: {
    ...
    posts: [
      ...
      {
        title:
          "10 eelist kogukonnaäpi kasutamiseks omavalitsustele ja kogukondadele",
  ...
  blogPage: {
    ...
    title: "Uudised",
    description:
      "Jälgi meie uudiseid, lugusid ja teadmisi! Kaasamislahendused erinevates valdkondades",
    categoryLabels: {
      news: "Uudised",
  ...
  contactsPage: {
    meta: {
      ...
      description:
        "Future Dialogi kontaktandmed ja kontaktivorm müügiosakonnaga",
    },
    title: "Kontakt",
