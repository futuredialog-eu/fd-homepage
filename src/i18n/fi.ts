...
export const fi: Content = {
  ...
  navigation: [
    ...
    { label: "Yhteystiedot", href: "/contacts/" },
    {
      ...
      href: "https://futuredialog.app/login",
      external: true,
    },
  ],
  policyLinks: [
  ...
  blogSection: {
    ...
    posts: [
      ...
      {
        title:
          "Kriisitiedot nopeasti yhteisön tietoon sovelluksen avulla: kokemustarina Elvan kunnalta",
  ...
  blogPage: {
    ...
    title: "Uutiset",
    description:
      "Seuraa uutisiamme, tarinoitamme ja näkemyksiämme! Osallistamisen ratkaisuja eri toimialoille",
    categoryLabels: {
      news: "Uutiset",
  ...
  contactsPage: {
    meta: {
      ...
      description:
        "Future Dialogin yhteystiedot ja yhteydenottolomake myyntiosastolle",
    },
    title: "Yhteystiedot",
